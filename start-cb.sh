...
: ${DOCKER_TAG_CLOUDBREAK:=0.4.10}
: ${DOCKER_TAG_ULUWATU:=0.4.7}
...
set_env_props() {
    ...
    export CB_GCP_SOURCE_IMAGE_PATH="sequenceiqimage/sequenceiq-ambari17-consul-centos-2015-04-02-1413.image.tar.gz"
    export CB_AWS_AMI_MAP="eu-west-1:ami-f3670284,us-east-1:ami-f8477690,ap-northeast-1:ami-34cd3134,sa-east-1:ami-29e45e34,ap-southeast-1:ami-8a2c1fd8,ap-southeast-2:ami-6132405b,us-west-2:ami-57c7ee67,us-west-1:ami-8d42a2c9"
